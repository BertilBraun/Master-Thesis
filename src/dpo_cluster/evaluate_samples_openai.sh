...
#SBATCH --job-name=evaluate_openai         # job name
...
#SBATCH --output=evaluate_openai_%j.txt
#SBATCH --error=evaluate_openai_%j.txt

source shared_slurm_setup.sh

python -m src.dpo_cluster.evaluate_samples_openai
